...
public class RsaEncryptUtil {
     ...
     * <br>默认"RSA"="RSA/ECB/PKCS1Padding"
     */
     ...
     */
    public static Map<String, String> generateKeyPair(boolean isKeyBase64) throws NoSuchAlgorithmException {
     ...
     */
    private static String enDecrypt(String text, String secretKey, boolean isPublicKey, boolean isEncrypt, boolean isKeyBase64, boolean isTextBase64) throws Exception {
        //base64编码的秘钥
    ...
    public static String encryptByPublicKey(String plainText, String publicKey, boolean isKeyBase64, boolean isTextBase64) throws Exception {
        return enDecrypt(plainText, publicKey, true, true, isKeyBase64, isTextBase64);
    }

    public static String decryptByPrivateKey(String cipherText, String privateKey, boolean isKeyBase64, boolean isTextBase64) throws Exception {
     ...
     * @return 签名值
     */
    public static String signByPrivateKey(String signText, String privateKey, boolean isKeyBase64, boolean isTextBase64) {
        String signValue = "";
        try {
     ...
     * 生成消息摘要
     */
    public static byte[] genDigest(String plainText, String algorithm) throws NoSuchAlgorithmException, UnsupportedEncodingException {
     ...
     * @return 布尔值
     */
    public static boolean verifySignPublicKey(String signText, String signedText, String publicKey, boolean isKeyBase64, boolean isTextBase64) {
    ...
    public static Map<String,String> convertKeyFormat(Map<String,String> mapSource, String keyMode) {
    ...
    public static Map<String,String>  removeHeaderAndBottom (Map<String,String> mapSource,String keyMode) {
    ...
    // 不带头和尾的密钥，按指定格式增加头和尾
    public static Map<String,String> formatKey(Map<String,String> mapSource, String keyMode) {
        Map<String,String> map = new HashMap<>();
    ...
    // 格式化key，增加头和尾
    private static String formatKey(String keyBody, String keyMode, boolean isPrivateKey) {
        ...
        StringBuilder strKey = new StringBuilder(keyHeader + "\n");

        int nPrivateKeyLen = keyBody.length();
        int row = nPrivateKeyLen / 64;
        int remain = nPrivateKeyLen % 64;
        for (int i = 0; i < row; i++) {
            strKey.append(keyBody, i * 64, i * 64 + 64).append("\n");
        }
        strKey.append(keyBody, row * 64, nPrivateKeyLen).append("\n");
        strKey.append(keyBottom);

        return strKey.toString();
    }

    // 按指定格式生成头和尾
    public static Map<String,String> genKeyHeaderAndBottom(String keyMode,boolean isPrivateKey) {
        Map<String,String> map = new HashMap<>();
    ...
    public static Map<String,String> loadFormatKey(Map<String,String> mapSource, String keyMode) {
        Map<String,String> map = removeHeaderAndBottom(mapSource, keyMode);
