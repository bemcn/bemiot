 ...
 * @author jakybland
 */
public class ProductAuthCodeDevValidator implements ConstraintValidator<ProductAuthCodeVerify, String> {
    @Resource
    ...
    public boolean isValid(String value, ConstraintValidatorContext constraintValidatorContext) {
        ...
        return productAuthCodeService.existsNotAuthCodeByDev(value);
    }
}
