package org.bem.iot.media.module.stack;
...
import org.bem.iot.media.model.param.VideoStackWindowParam;
...
public class VideoStack {
    ...
    private final List<VideoStackWindow> windowList = new ArrayList<>();
    ...
    public void init() {
        ...
        initStackWindow();
        initStatus = true;
        MediaServerThreadPool.execute(this::initEncodeAndPush);
    }
