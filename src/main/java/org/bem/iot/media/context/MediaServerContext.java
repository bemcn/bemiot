package org.bem.iot.media.context;
...
public class MediaServerContext {
    ...
    public void initMediaServerConf() {
        ...
        //初始化zmk服务器
        ZLM_API.mk_env_init2(config.getThread_num(), config.getLog_level(), config.getLog_mask(), config.getLog_path(), config.getLog_file_days(), 0, null, 0, null, null);
    }
