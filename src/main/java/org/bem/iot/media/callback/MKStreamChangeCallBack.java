package org.bem.iot.media.callback;
...
import org.bem.iot.media.service.TestVideoService;
import org.bem.iot.media.service.TranscodeService;
...
public class MKStreamChangeCallBack implements IMKStreamChangeCallBack {
    ...
    public void invoke(int regist, MK_MEDIA_SOURCE sender) {
        ...
        //停止测试流
        if (regist == 0) {
            testVideoService.stopTestVideo(app,stream);
        }
    }
}
